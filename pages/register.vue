        ...
        <div class="d-flex align-center justify-center" style="height: 100vh">
          ...
          >
            ...
            <form
              ...
              id="register-f"
              class="d-flex flex-column align-center shrink"
            >
              <input
              ...
              <v-btn
                ...
                type="submit"
                form="register-f"
                class="button-submit my-8 white--text rounded-lg"
                >Register</v-btn
              >
            </form>
            ...
            >
              ...
              <v-btn
                ...
                type="submit"
                form="confirm-f"
                class="button-submit mt-8 white--text rounded-lg"
                >Confirm</v-btn
              >
            </form>

            <nuxt-link to="/login" style="text-decoration: none; color: gray"
              >Already have an account?
              <span style="text-decoration: underline; color: #232323"
                >Login</span
              ></nuxt-link
            >
          </v-card>
